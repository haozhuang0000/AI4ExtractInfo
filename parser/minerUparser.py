...
if __name__ == '__main__':
    ...
    demo_names = ['[AR] -2011 - Investor Trading and the Post-Earnings-Announcement Drift', 
    '[AR] The Reversal of Abnormal Accruals and the Market Valuation of Earnings Surprises', 
    '[JAE] - 2015 - Market (in)attention and the strategic scheduling and timing of earnings announcements',
    '[JAE] - 2020 - Market uncertainty and the importance of media coverage at earnings announcements']
